...
\todo[inline]{Approximate numerical value of A matrix}
\todo[inline]{Approximate numerical value of B matrix}
\todo[inline]{OPTIONAL: description of $x_1,$ $x_2, \ldots$}

\todo[inline]{Provide realistic value of target pressure (in PSI)}
\todo[inline]{Provide realistic value of target flow rate (in Gal/Acre)}
...
The solution will be implemented on an embedded system \todo{TeeJet ECU or Raspberry Pi?}.
