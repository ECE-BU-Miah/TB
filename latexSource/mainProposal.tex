...
% %% For Preview-latex using commands like C-c C-p C-s for previewing a  section. 
...
\newwatermark[allpages,color=red!15,angle=45,scale=3,xpos=0,ypos=0]{DRAFT}  % or "firstpage"
